...
const About = () => {
  ...
  return (
    <div name='about' className='w-full h-screen bg-[#0a192f] text-gray-300' style={backgroundStyle}>
      ...
      <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
        ...
        <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
          <div className='sm:text-right text-4xl font-bold'>
            <p>Hi. I'm Matt Sanchez, nice to meet you. Please take a look around.</p>
          </div>
          <div>
